...
class ConcurrencyTest extends TestCase
{
    ...
    public function test_concurrent_bets_are_handled_correctly(): void
    {
        ...
        $this->assertGreaterThanOrEqual(5, $transactionCount);
    ...
    public function test_concurrent_bets_with_insufficient_funds_are_rejected(): void
    {
        ...
        if ($responses[2]->status() === 400) {
            ...
            $this->assertStringContainsString('Insufficient balance', $responses[2]->json('message'));
        } else {
        ...
        $user->refresh();
        $this->assertGreaterThanOrEqual(0.00, $user->balance);
    }
