                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                    ...
                                    <ul id="tocify-subheader-endpoints" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="endpoints-POSTapi-spin">
                                <a href="#endpoints-POSTapi-spin">POST api/spin</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-deposit">
                                <a href="#endpoints-POSTapi-deposit">POST api/deposit</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-balance">
                                <a href="#endpoints-GETapi-balance">GET api/balance</a>
                            </li>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-POSTapi-spin">POST api/spin</h2>
...
<span id="example-requests-POSTapi-spin">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/spin" \
...
<span id="example-responses-POSTapi-spin">
</span>
<span id="execution-results-POSTapi-spin" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-spin"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-spin"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-spin" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-spin">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-spin" data-method="POST"
      data-path="api/spin"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-spin', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-spin"
                    onclick="tryItOut('POSTapi-spin');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-spin"
                    onclick="cancelTryOut('POSTapi-spin');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-spin"
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-spin"
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-spin"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
        ...
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>bet_amount</code></b>&nbsp;&nbsp;
<small>number</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="bet_amount"                data-endpoint="POSTapi-spin"
               value="1"
               data-component="body">
    <br>
<p>Must be at least 0.01. Must not be greater than 1000. Example: <code>1</code></p>
        </div>
        </form>
...
<span id="execution-results-POSTapi-deposit" hidden>
    ...
    <pre class="json"><code id="execution-response-content-POSTapi-deposit"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-deposit" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-deposit">
...
<form id="form-POSTapi-deposit" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            ...
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-deposit"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-deposit"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-deposit"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>number</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="amount"                data-endpoint="POSTapi-deposit"
               value="1"
               data-component="body">
    <br>
<p>Must be at least 0.01. Must not be greater than 10000. Example: <code>1</code></p>
        </div>
        </form>

                    <h2 id="endpoints-GETapi-balance">GET api/balance</h2>
